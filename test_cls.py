...
from predict_cls import validate_softmax
from models.clswiseformer.cls_wise_former import get_cls_wise_former

parser = argparse.ArgumentParser()

parser.add_argument('--user', default='bitgroup_all', type=str)

parser.add_argument('--project_root', default='rundata/cls_wise_attention_one_supervise', type=str)
...
parser.add_argument('--experiment', default='superviseclswiseformerone', type=str)

parser.add_argument('--test_date', default='20220727', type=str)
