...
from data.ClsWiseBraTS import BraDataSet
...
parser.add_argument('--user', default='bitgroupxfa', type=str)

parser.add_argument('--project_root', default='clswiseformer', type=str)
...
parser.add_argument('--experiment', default='clswiseformer', type=str)

parser.add_argument('--test_date', default='20220706', type=str)

parser.add_argument('--test_file', default='model_epoch_299.pth', type=str)
...
# parser.add_argument('--model_name', default='clswiseformer', type=str)
...
def main():
    ...
    if os.path.exists(load_file):
        ...
        #         mitem = key[7:]
        #         kk = sd[key]
        #         new_state_dict[mitem]=kk
        #
        # for key, _ in new_state_dict.items():
        #     print(key, '\n')
    ...
    valid_set = BraDataSet(valid_list, valid_root, mode='valid', drop_modal=True)
