...
# Basic Information
parser.add_argument('--user', default='bitgroup_21_concat', type=str)

parser.add_argument('--experiment', default='clswiseformer_21_concat', type=str)
...
parser.add_argument('--project_root', default='cls_wise_concat', type=str)
